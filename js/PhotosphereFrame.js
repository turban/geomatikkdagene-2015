THREE.PhotosphereFrame = function (domEl, image, options) {
	options = options || {};
	...
	function init () {
		...
		camera = new THREE.PerspectiveCamera(options.fieldOfView || 100, domEl.offsetWidth / domEl.offsetHeight, 1, 1000);
